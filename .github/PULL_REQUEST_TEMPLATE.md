...
- [ ] This change changes runtime behavior and has maintainer approval.
- [ ] This change changes a dependency patch or renderer boundary and has
      maintainer approval.
- Human decision or issue link:
- Trade-offs still requiring a decision:
