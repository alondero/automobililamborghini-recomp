...
#
# Run (WSL, ABI-matched recompiler from spike #55):
#   wsl bash -c 'cd /mnt/f/src/automobililamborghini-decomp/recomp && \\
#     build-wsl/lib/N64ModernRuntime/librecomp/N64Recomp/N64Recomp lamborghini.us.toml'
#   (the N64Recomp CLI is built in-tree on F: via `make -C recomp/build-wsl N64RecompCLI`.)
