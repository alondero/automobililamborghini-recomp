...
The current audit ROM identity is recorded in
[the current-state reference](docs/reference/current-state.md). Do not publish
the ROM or place it in a build artifact.
